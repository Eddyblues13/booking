                ...
                <form action="{{ route('booking.store') }}" method="POST" id="bookingForm"
                    ...
                    <div class="booking-card">
                        ...
                        <div class="flight-summary">
                            <div class="summary-row">
                                ...
                                <span class="summary-value">QR 107</span>
                            </div>
                            <div class="summary-row">
                                <span class="summary-label">Airline</span>
                                <span class="summary-value">Qatar Airways</span>
                            </div>
                            <div class="summary-row">
                                <span class="summary-label">Route</span>
                                <span class="summary-value">Doha (DOH) → London (LHR)</span>
                            </div>
                            <div class="summary-row">
                                <span class="summary-label">Departure</span>
                                <span class="summary-value">15 Oct 2024 - 08:30 AM</span>
                            </div>
                            <div class="summary-row">
                                <span class="summary-label">Arrival</span>
                                <span class="summary-value">15 Oct 2024 - 01:45 PM</span>
                            </div>
                            <div class="summary-row">
                                <span class="summary-label">Duration</span>
                                <span class="summary-value">7h 15m</span>
                            </div>
                            <div class="summary-row">
                                <span class="summary-label">Class</span>
                                <span class="summary-value">Economy Class</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="passenger-form">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select name="passengers[0][title]" class="form-select" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="passengers[0][first_name]" class="form-control"
                                        placeholder="Enter first name" required maxlength="50">
                                    <div class="invalid-feedback">Please enter your first name.</div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Last Name *</label>
                                    <input type="text" name="passengers[0][last_name]" class="form-control"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="passengers[0][nationality]" class="form-select" required>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="passengers[0][passport_country]" class="form-select" required>
                            ...
                            <div class="form-row">
                                <div class="form-group form-group-full">
                                    ...
                                    <input type="email" name="passengers[0][email]" class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="passengers[0][phone]" class="form-control"
                                        placeholder="+974 1234 5678" required>
                                    <div class="invalid-feedback">Please enter a valid phone number.</div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Frequent Flyer Number</label>
                                    <input type="text" name="passengers[0][frequent_flyer]" class="form-control"
                            ...
                            <div class="document-upload" id="documentUpload">
                                ...
                                <input type="file" name="passengers[0][passport_copy]" accept=".pdf,.jpg,.jpeg,.png"
                                    style="display: none;" id="passportFile">
                    ...
                    <div class="booking-card">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" name="contact_phone_secondary" class="form-control"
                                    placeholder="Optional">
                            </div>
                        </div>
                        <div class="form-row">
                    ...
                    <div class="booking-card">
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="terms_accepted" id="termsAccepted"
                                required>
                    ...
                    <div class="mt-4 pt-4 border-top">
                        ...
                        <div class="small">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <div>
                                    <strong>DOH</strong>
                                    <div class="text-muted">08:30</div>
                                </div>
                                <div class="text-center flex-grow-1 mx-3">
                                    <div class="text-muted">7h 15m</div>
                                ...
                                <div>
                                    <strong>LHR</strong>
                                    <div class="text-muted">13:45</div>
                                </div>
                            </div>
                            <div class="text-muted">
                                <div>15 Oct 2024</div>
                                <div>Qatar Airways · QR 107</div>
...
<script>
    ...
    const validateForm = () => {
        ...
        // Date validation
        const dobField = form.querySelector('input[name="passengers[0][date_of_birth]"]');
        if (dobField.value) {
        ...
        const passportExpiry = form.querySelector('input[name="passengers[0][passport_expiry]"]');
    ...
    form.addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            // In real application, this would be an AJAX call or form submission
            console.log('Form submitted successfully');
            
            // Redirect to payment page (in real application)
            loadingModal.hide();
            ...
            if (files.length > 0) {
                ...
                if (file.type.match('image.*') || file.type === 'application/pdf') {
                    ...
                    documentUpload.innerHTML = `
                        ...
                        <button type="button" class="btn btn-outline-secondary btn-sm" onclick="resetDocumentUpload()">
                            Change File
                        </button>
                    `;
                } else {
...
function resetDocumentUpload() {
    ...
    documentUpload.innerHTML = `
        ...
        <h5>Upload Passport Copy</h5>
        <p class="text-muted">Drag & drop your passport copy here or click to browse</p>
        <button type="button" class="btn btn-outline-primary mt-2" onclick="document.getElementById('passportFile').click()">
            <i class="fas fa-upload me-2"></i>Choose File
        </button>
    `;
    passportFile.value = '';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const dobField = document.querySelector('input[name="passengers[0][date_of_birth]"]');
    if (dobField) {
    ...
    const passportExpiry = document.querySelector('input[name="passengers[0][passport_expiry]"]');
    if (passportExpiry) {
